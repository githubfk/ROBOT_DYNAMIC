...
function Ti = niudun_oula_formula(theta, dtheta, ddtheta)
...
dVi_1_i_1(:,1) = [0; 9.6511; 1.7018];            %给定初始加速度g，作为重力的影响
...
Mass = [ 257.27572822  78.58091036  82.07360471]; %1x3矩阵，每一列表示各个杆件的质量
